...
# in their own submodule (see, e.g., MIDI). Ideally there would be no calls to
# `in_sonic_pi?` outside of those modules either - all such switching should be
# isolated.
#
