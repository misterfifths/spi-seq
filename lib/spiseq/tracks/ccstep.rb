...
module SpiSeq; module Tracks
  # A CCStep represents a sequenceable MIDI CC event which can appear in slots
  # in the grid of a {CCTrack}. See the {StepBase} documentation for details
  ...
  class CCStep < StepBase
    ...
    # @param cc [Integer] The CC number for this event; see {#cc}. It is an
    #   error to pass a value outside of 0 - 127 inclusive.
    # @param value [Integer] The value for the CC event (subject to
